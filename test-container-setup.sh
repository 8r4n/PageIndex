...
echo "4. Run PageIndex: docker run --rm -v \$(pwd)/data:/app/data -v \$(pwd)/results:/app/results --env-file .env pageindex:latest python3 run_pageindex.py --pdf_path /app/data/your-file.pdf"
echo ""
